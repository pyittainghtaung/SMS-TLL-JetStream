                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between flex-col sm:flex-row gap-2">
                        <div class="basis-1/3 rounded-lg border-solid border-2 border-green-500 p-2">
                            ...
                            @endif
                            <h1 class="text-center">{{ $isEdit ? 'Edit' : 'Create' }} Permissions</h1>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex gap-2">
                                                    <x-secondary-button wire:click="edit({{ $permission->id }})"
                                                        class="btn btn-primary">Edit</x-secondary-button>
                                                    <x-secondary-button wire:click="delete({{ $permission->id }})"
